...
export function JoinGuestlistModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-lg bg-white rounded-lg p-8 shadow-2xl">
        {showSuccess ? (
          <div className="text-center flex flex-col items-center">
            ...
            <p className="text-slate-600 mb-6 max-w-md">
              ...
              <br />
              <br />
              We’ll send your confirmation and event details shortly, get ready for
              sunshine, music, and champagne.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Select onValueChange={setHowHeard} value={howHeard}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Partner Brand">Partner Brand</SelectItem>
              ...
              <div className="flex items-center space-x-4 pt-2">
                ...
                <Label htmlFor="terms" className="text-sm font-normal text-slate-600 leading-tight">
                    I confirm that I am 18+ and understand that entry is subject to confirmation and event capacity.
                </Label>
              </div>
              <Button type="submit" className="w-full pt-4" disabled={isSubmitting || !isConfirmed}>
