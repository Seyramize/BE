...
export type Experience = {
  ...
  export const experiences: Experience[] = [
...

    {
      ...
      defaultContent: {
        title: "Cape Coast After Dark",
        shortDescription: "Step into history under the cover of night with an exclusive after-dark tour of Cape Coast Castle.",
        image: "/images/experiences/cape-coast-after-dark/cover.jpg?height=400&width=300&text=Cape+Coast+After+Dark",
        location: "Central Region, Ghana"
      },
      expandedContent: {
      ...
      bookingContent: {
        ...
        destinations: "3 DESTINATIONS",
        maxGuests: "12 GUESTS (MAX)",
        heroImage: "/images/experiences/cape-coast-after-dark/cover.jpg?height=800&width=1200&text=Cape+Coast+Castle",
        galleryImages: [
          "/images/experiences/cape-coast-after-dark/Gallery/1.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/2.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/3.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/4.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/5.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/6.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/7.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/8.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/9.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/images/experiences/cape-coast-after-dark/Gallery/10.jpg?height=400&width=300&text=Cape+Coast+Castle+2",
        ],
    ...
    },
    {
      ...
      bookingContent: {
        ...
        galleryImages: [
          ...
          "/images/experiences/wojutei/Gallery/10.jpg?height=400&width=300&text=Kente+Weaving",
          "/images/experiences/wojutei/Gallery/11.jpg?height=400&width=300&text=Kente+Weaving",
          "/images/experiences/wojutei/Gallery/12.jpg?height=400&width=300&text=Kente+Weaving",
          "/images/experiences/wojutei/Gallery/13.jpg?height=400&width=300&text=Kente+Weaving",
        ],
        overview: "Guests arrive at The Tree House Aburi and are welcomed by their host. The evening begins with a gentle walk through the home. Wood, light, and open air set the tone. The pace slows a s the space reveals itself, room by room, without urgency. Wojutei unfolds a s a considered, multi-course dining experience hosted by Chef Fiifi. Each dish is shaped by memory, heritage, and quiet creativity. The rhythm is deliberate. Conversation deepens as the meal progresses, unhurried and present. The setting is a private, wood-framed home held within the Aburi Mountains. In partnership with The Tree House Aburi, the experience is designed to exist gently within its natural surroundings. Cool mountain air moves through open spaces. Trees remain close. Calm carries the night for ward. Before the meal begins, Chef Fiifi shares the intention behind the table. Guests are invited into a hands-on moment during the opening course, assisting in the preparation of the starter. It is an intimate introduction that grounds the evening in participation and care. As the final course concludes, guests are guided outdoors for tea beneath the cinnamon tree. The structure softens. Conversation loosens. Stories linger in the open air as the evening settles into a quieter, more reflective rhythm. Wojutei is more than dinner. It is a gathering shaped by care, intention, and shared presence. An evening designed to linger well beyond the table.",
    ...
    {
      id: 21,
      slug: "december-in-accra",
      hidden: false,
      accessCode: ["travelsocial", "bxnoah"],
      defaultContent: {
        title: "December in Accra",
        shortDescription: "An immersive December escape designed to experience Accra at its most vibrant — where culture, celebration, and coastal living come together in perfect rhythm.",
        image: "/images/experiences/dec-in-accra/cover2.jpg?height=400&width=300&text=December+Ghana+Group+Experience",
        location: "Ghana"
      },
      expandedContent: {
        title: "December in Accra",
        fullDescription: "An immersive December escape designed to experience Accra at its most vibrant — where culture, celebration, and coastal living come together in perfect rhythm.",
      ...
      bookingContent: {
        ...
        galleryImages: [
          ...
          "/images/experiences/dec-in-accra/Gallery/3.jpg?height=400&width=300&text=Accra+City+Tour",
          "/images/experiences/dec-in-accra/Gallery/4.jpg?height=400&width=300&text=Accra+City+Tour",
          "/images/experiences/dec-in-accra/Gallery/5.webp?height=400&width=300&text=Accra+City+Tour",
          "/images/experiences/dec-in-accra/Gallery/6.jpg?height=400&width=300&text=Accra+City+Tour",
          "/images/experiences/dec-in-accra/Gallery/7.jpg?height=400&width=300&text=Accra+City+Tour",
          "/images/experiences/dec-in-accra/Gallery/8.jpg?height=400&width=300&text=Accra+City+Tour",
          "/images/experiences/dec-in-accra/Gallery/9.jpg?height=400&width=300&text=Accra+City+Tour",

        ],
        overview: "An immersive December escape designed to experience Accra at its most vibrant — where culture, celebration, and coastal living come together in perfect rhythm. This curated eight-day journey blends cultural discovery, festive energy, and moments of ease. From hands-on creative workshops and market explorations to beach club days, nightlife, and iconic December events, every experience is designed to capture the spirit of the season. Venture beyond the city for an Akosombo escape featuring ATV adventures and a scenic Volta Lake cruise, then return to Accra for curated dining, cultural immersion, and unforgettable celebrations — including AfroFuture festivities and a New Year’s Eve experience to close the year in style.",
        highlights: [
          "Akosombo day trip with quad biking & Volta Lake boat cruise",
          "AfroFuture festival experience & after party",
          "Beach club day with optional horseback riding",
          "“A Seat at the Table” curated dining & creative experience",
          "Accra city mini tour (Jamestown, Kwame Nkrumah Museum, Black Star Square)",
          "New Year’s Eve celebration",
          "Creative workshops (pottery, dance & drum, bead making)",
          "Makola Market visit & cultural immersion",
          "Fisherman experience in Jamestown",
          "Curated nightlife experiences throughout",
          "Seamless group transportation",

        ],
        startingPrice: 88041.2,
        pricing: {
          oneGuest: 88041.2,
          twoGuests: 88041.2,
          threeOrMoreGuests: 88041.2,
        },
        minimumGuests: 1,
        included: [
          "Airport transfers",
          "Accommodation",
          "Daily curated experiences & activities",
          "Akosombo excursion (ATV + Boat cruise)",
          "Creative workshops & cultural experiences",
          "Guided city tour",
