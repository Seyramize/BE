  ...
  export const experiences: Experience[] = [
    ...
    },
    {
      ...
      bookingContent: {
        ...
        heroImage: "/placeholder.svg?height=800&width=1200&text=Cape+Coast+Castle",
        galleryImages: [
          "/placeholder.svg?height=400&width=300&text=Cape+Coast+Castle+1",
          "/placeholder.svg?height=400&width=300&text=Cape+Coast+Castle+2",
          "/placeholder.svg?height=400&width=300&text=Cape+Coast+Castle+3",
        ],
    ...
    },
    {
      ...
      bookingContent: {
        ...
        heroImage: "/placeholder.svg?height=800&width=1200&text=Accra+City+Tour",
        galleryImages: [
          "/placeholder.svg?height=400&width=300&text=Makola+Market",
          "/placeholder.svg?height=400&width=300&text=Kwame+Nkrumah+Mausoleum",
          "/placeholder.svg?height=400&width=300&text=Jamestown+Lighthouse",
        ],
    ...
    },
    {
      ...
      defaultContent: {
        ...
        image: "/placeholder.svg?height=400&width=300&text=Kente+Weaving+Workshop",
        location: "Greater Accra, Ghana",
      },
      expandedContent: {
      ...
      bookingContent: {
        ...
        heroImage: "/placeholder.svg?height=800&width=1200&text=Kente+Workshop",
        galleryImages: [
          "/placeholder.svg?height=400&width=300&text=Kente+Weaving",
          "/placeholder.svg?height=400&width=300&text=Drumming+Session",
          "/placeholder.svg?height=400&width=300&text=Traditional+Dance",
        ],
    ...
    },
    {
      ...
      bookingContent: {
        ...
        heroImage: "/placeholder.svg?height=800&width=1200&text=Chocolate+Spa",
        galleryImages: [
          "/placeholder.svg?height=400&width=300&text=Chocolate+Workshop",
          "/placeholder.svg?height=400&width=300&text=Resense+Spa",
          "/placeholder.svg?height=400&width=300&text=Luxury+Relaxation",
        ],
    ...
    },
    {
      ...
      bookingContent: {
        ...
        destinations: "3 DESTINATIONS",
        maxGuests: "12 GUESTS (MAX)",
        heroImage: "/placeholder.svg?height=800&width=1200&text=Volta+Lake+Adventure",
        galleryImages: [
          "/placeholder.svg?height=400&width=300&text=Abseiling+Cliffs",
          "/placeholder.svg?height=400&width=300&text=Kayaking+Volta",
          "/placeholder.svg?height=400&width=300&text=Sunset+Boat+Cruise",
        ],
