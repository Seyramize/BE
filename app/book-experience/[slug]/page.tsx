    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[60vh] md:min-h-screen flex items-center justify-center">
        ...
        <div className="relative text-center text-white z-10 px-4 max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-argentt font-normal mb-4 md:mb-6 leading-tight">
            {experienceData.title}
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 md:mb-8 max-w-3xl mx-auto font-helvetica leading-relaxed">
            {experienceData.subtitle}
          </p>

          {/* Experience Details */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-8 text-white/90 font-helvetica text-sm uppercase tracking-wider">
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-8 md:space-y-12">
              {/* Overview */}
              <div>
                <h2 className="text-lg sm:text-xl font-helvetica font-bold mb-4 md:mb-6 uppercase tracking-wider text-slate-800">
                  Overview
                </h2>
                <p className="text-slate-700 font-argentt font-bold leading-relaxed text-base sm:text-xl">
              ...
              {/* Highlights */}
              <div>
                <h2 className="text-lg sm:text-xl font-helvetica font-bold mb-4 md:mb-6 uppercase tracking-wider text-slate-800 border-b border-black pb-2">
                  Highlights
                </h2>
                <div className="space-y-4">
                  {experienceData.highlights.map((highlight, index) => (
                    <div key={index} className="flex items-start gap-3 border-b border-black pb-4">
                      ...
                      <p className="text-slate-700 font-helvetica leading-relaxed text-base sm:text-lg">
                        {highlight}
                      </p>
                    </div>
                  ))}
              ...
              <div className="border-t border-gray-200 pt-8 md:pt-12">
                <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
                  <div>
                    <h3 className="text-lg font-helvetica uppercase tracking-wider text-slate-600 mb-3">
                      Starting Price
                    </h3>
                    <div className="flex justify-between items-center gap-16 mt-2">
                      <div className="relative">
                        <span className="mt-2 text-4xl sm:text-5xl font-argent font-normal text-slate-800">
                          ${experienceData.startingPrice}
                        </span>
                        <span className="absolute -top-1 right-[-2rem] text-xl text-slate-600 font-argent">.00</span>
                      </div>
                      <p className="text-xl text-slate-600 font-helvetica text-bold">
                  ...
                  <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3">
                    <Button
                      className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 text-white font-helvetica px-6 sm:px-8 py-3 rounded-none"
                    ...
                    <Link href="/customize-experience" className="w-full sm:w-auto">
                      <Button
                        variant="outline"
                        className="w-full border-slate-300 text-slate-700 hover:bg-slate-50 font-helvetica px-6 sm:px-8 py-3 rounded-none"
                      >
              ...
              {/* What's Included */}
              <div>
                <h2 className="text-md sm:text-lg font-helvetica font-bold mb-4 md:mb-6 uppercase tracking-wider text-slate-800">
                  What's Included
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {experienceData.included.map((item, index) => (
                    <div key={index} className={`flex items-center gap-3 border-b border-black pb-3 ${index < 2 ? 'border-t border-black pt-3' : ''}`}>
                      ...
                      <span className="text-slate-700 font-helvetica text-sm sm:text-base">
                        {item}
                      </span>
                    </div>
                  ))}
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24">
                <div className="relative">
                  ...
                  <Button
                    variant="outline"
                    className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm border-white/50 text-slate-700 hover:bg-white font-helvetica px-4 py-2 rounded-full"
      ...
      <section className="py-8 sm:py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="flex items-center gap-3 mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-argent font-normal text-slate-800">
              More Ghanaian adventures
            </h2>
              ...
              <div key={experience.id} className="group">
                <div className="relative h-48 sm:h-56 rounded-lg overflow-hidden mb-4">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="text-lg sm:text-xl font-argent text-white mb-2">
                      {experience.title}
                    </h3>
                    <p className="text-white/90 text-sm font-helvetica leading-relaxed mb-3 line-clamp-2">
                      {experience.description}
                    </p>
                    <Button
                      size="sm"
                      className="bg-white/20 hover:bg-white/30 text-white font-argentt px-8 py-3 rounded-full backdrop-blur-sm border border-white/30">
                      Book Experience
                    </Button>
                  </div>
                </div>
